    ...
    <div>
      <div className="circle-wrapper">
        <div className="home-wrapper">
          <div>
            <h1>ApexClinic — a holistic healthcare consultation service.</h1>
            <p>
      ...
      <section className="home-section">
        <div className="home-grid">
          ...
          <div className="col-r">
            <h2>Features</h2>
            <p>
              ApexClinic improves access to medical consultations for people in
      ...
      <section className="home-section">
        <footer className="home-grid">
          <div className="col-l">
            <h2>About</h2>
            <p>
              ApexClinic is the  project from of 21 Century Informatics  
            ...
            {/* <ul>
              <li>
                <a
                  href="https://github.com/dukeraphaelng/ApexClinic"
                  target="_blank"
          ...
          <small>
            &copy; Copyright {new Date().getFullYear()}, ApexClinic
          </small>
        </footer>
      </section>
    </div>
